...
class LLMDirector:
    ...
    def _local_system_prompt(self) -> str:
        return (
            ...
            + "Invalid speech examples: 'I'm moving left', 'I'll gather wood', 'Heading toward tall grass', 'I'll check the area', 'I'll keep an eye out', 'I need to craft better tools', 'Moving one step to the right'. "
    ...
    def _developer_prompt() -> str:
        return (
            ...
            "'I'll check the area', 'Maybe I should check that', 'I need to gather resources', 'I'll need some wood to make a campfire', "
            "'I need to set up a workbench', or 'I need to craft better tools'. Those belong in thought, not speech. "
